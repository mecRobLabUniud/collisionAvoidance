...
const MESH_FILES = ['link0','link1','link2','link3','link4','link5','link6','link7','hand','finger'];
  ...
  return new Promise((resolve, reject)=>{
    loader.load(
      ...
      (collada) => {
        ...
        // ColladaLoader auto-applies a Z_UP -> Y_UP correction (Rx(-90deg)) plus
        // asset.unit scaling onto collada.scene. Our own FK matrices already
        // perform that same conversion once, so cancel the loader's built-in
        // correction here to avoid applying it twice.
