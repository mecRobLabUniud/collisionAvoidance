...
def extractArray(running, pipe, align, model, smoother, T_base_cam, pub, video_writer):
    while running:
...
def main():    
    ...
    # Create threads
    thread1 = threading.Thread(target=extractArray, args=(running, pipes[0], align, model, smoother, T_base_cam, pub, video_writer))
    thread2 = threading.Thread(target=extractArray, args=(running, pipes[1], align, model, smoother, T_base_cam, pub, video_writer))
